...
export const organizationModuleEntitlements = sqliteTable(
 ...
 */
export const crmReminders = sqliteTable(
  "crm_reminders",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const crmInquiries = sqliteTable(
  "crm_inquiries",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const crmInquiryLeads = sqliteTable(
  "crm_inquiry_leads",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const crmMeetings = sqliteTable(
  "crm_meetings",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const integrationConnections = sqliteTable(
  "integration_connections",
  {
    ...
    // not touched since.
    fullResync: integer("full_resync", { mode: "boolean" })
      .notNull()
      .default(false),
...
export const whatsappContactProfiles = sqliteTable(
  "whatsapp_contact_profiles",
  {
    ...
    marketingOptIn: integer("marketing_opt_in", { mode: "boolean" })
      .notNull()
      .default(false),
    utilityOptIn: integer("utility_opt_in", { mode: "boolean" })
      .notNull()
      .default(false),
    useWhatsappName: integer("use_whatsapp_name", { mode: "boolean" })
      .notNull()
      .default(true),
    updatedAt: text("updated_at")
      .notNull()
...
export const whatsappTags = sqliteTable(
  "whatsapp_tags",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const whatsappContactTagAssignments = sqliteTable(
...
export const whatsappContactAttributes = sqliteTable(
...
export const whatsappInternalNotes = sqliteTable(
...
export const whatsappCampaigns = sqliteTable(
  "whatsapp_campaigns",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const whatsappAutomationRules = sqliteTable(
...
export const whatsappOrderRequests = sqliteTable(
...
export const voiceAgentConfigs = sqliteTable(
  "voice_agent_configs",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const voiceAgentLessons = sqliteTable(
  "voice_agent_lessons",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const voiceConversations = sqliteTable(
  "voice_conversations",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const voiceConversationMessages = sqliteTable(
 ...
 */
export const voicePhoneCalls = sqliteTable(
  "voice_phone_calls",
  {
    id: text("id").primaryKey(),
    organizationId: text("organization_id")
...
export const businessAuditEvents = sqliteTable(
...
export const commerceProducts = sqliteTable(
  "commerce_products",
  {
    ...
    parentProductId: text("parent_product_id").references(
      (): AnySQLiteColumn => commerceProducts.id,
      { onDelete: "set null" },
    ),
    name: text("name").notNull(),
...
export const commerceOrderLines = sqliteTable(
...
export const socialConversations = sqliteTable(
