...
target**. If a live opportunity already matches, it is *updated* — fresh
...
```json
{
  ...
  "rows": [
    { "query": "…", "page": "https://…", "impressions": 6,
      "clicks": 0, "ctr": 0, "position": 10 }
  ]
}
```
...
```json
{
  "keyword": "…", "fetchedAt": "2026-09-08", "market": "Australia",
...
They render as a dashed *"Image to add"* slot naming the alt text and the brief
