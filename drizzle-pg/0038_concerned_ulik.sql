ALTER TABLE "whatsapp_connections" ADD COLUMN "phone_number_id" text;--> statement-breakpoint
ALTER TABLE "whatsapp_connections" ADD COLUMN "business_account_id" text;--> statement-breakpoint
ALTER TABLE "whatsapp_connections" ADD COLUMN "last_checked_at" text;--> statement-breakpoint
ALTER TABLE "whatsapp_connections" ADD COLUMN "last_error" text;--> statement-breakpoint
...
CREATE UNIQUE INDEX "whatsapp_connections_provider_phone_idx" ON "whatsapp_connections" USING btree ("provider","phone_number_id");